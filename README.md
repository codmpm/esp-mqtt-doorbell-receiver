...
The ESP-01 needs 3.3V so you need to level-shift the output of the receiver module (5V) before feeding it into the ESP. I've used a voltage divider (20kΩ/10kΩ) which is not the best way but worked very well. The output is wired to `GPIO2` of the ESP.
...
You will have to use the receive-example demo to get your specific radio code for your doorbell button.
